...
/**
 * Instrumentenverweise generated by hbm2java
 */
public class Instrumentenverweise implements java.io.Serializable {

	private int id;
	private Adressen adressen;
	private Integer eigenschaftId;

	public Instrumentenverweise() {
	}

	public Instrumentenverweise(int id) {
		this.id = id;
	}

	public Instrumentenverweise(int id, Adressen adressen, Integer eigenschaftId) {
		this.id = id;
